...
public class ProjectManager implements Serializable {
    ...
    public ProjectManager(Integer id, Integer projectId, Integer userId, Integer revision, Integer createdBy, Date createdTime) {
        this.id = id;
    ...
    public boolean equals(Object that) {
        ...
        ProjectManager other = (ProjectManager) that;
